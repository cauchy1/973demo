...
/**
 * Servlet implementation class PantageProxy
 */
public class PantageProxy extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/xml; charset=UTF-8");
		  ...
		  String sWUrl="http://localhost:8090/HydrologyIntergrationComponent/IgPondageService?method=getPondage&params="+p+"&id=1";
