...
/**
 * Servlet implementation class StationInfoProxy
 */
public class StationInfoProxy extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StationInfoProxy() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/xml; charset=UTF-8");
		  ...
		  String sWUrl="http://localhost:8068/HydrologyStationPortalComponent/StationPortalService?method=execute&params="+p+"&id=1";
